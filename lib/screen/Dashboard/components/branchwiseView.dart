...
import 'package:seematti/screen/Dashboard/components/salesdetailscard.dart';
                ...
                InkWell(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                        ...
                        color:
                            (branchWiseController == 0) ? Colors.white : null),
                ...
                InkWell(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                        borderRadius: BorderRadius.circular(8),
                        color:
                            (branchWiseController == 1) ? Colors.white : null),
          ...
          if (SearchText == "")
            Column(
              children: [
                ...
                if (branchWiseController == 0)
                  tx500(
                      (ctrl.BS.length != (ctrl.BranchList.length))
                          ? "Sales - ${(ctrl.BS.map((element) => element.toString()).join(', ')).toString().capitalizeFirst}"
                          : "Sales -  All Branch",
                      size: 13,
                      color: Colors.black),
                if (branchWiseController == 1)
                  tx500(
                      (ctrl.BS.length != (ctrl.BranchList.length))
                          ? "Profit - ${(ctrl.BS.map((element) => element.toString()).join(', ')).toString().capitalizeFirst}"
                          : "Profit -  All Branch",
                      size: 13,
                      color: Colors.black),
                height(2.5.h),
