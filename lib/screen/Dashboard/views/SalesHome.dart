                      ...
                      children: [
                        Container(
                          ...
                          decoration: BoxDecoration(
                              borderRadius: BorderRadius.circular(10),
                              color: Colors.white),
                          child: tx600("Today", color: primaryColor, size: 14),
                        ),
                    ...
                    child: Stack(
                      children: [
                        ...
                        Positioned(
                            ...
                            top: 40,
                            child:
                                tx500("Sales", size: 13, color: Colors.white)),
                        Positioned(
                            left: 40,
                            top: 60,
            ...
            Container(
              ...
              child: Row(
                ...
                children: [
                  ...
                  tx600("$synctime", size: 11, color: Color(0xffB8293B))
                ],
              ),
            )
        ],
